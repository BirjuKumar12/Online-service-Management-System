...
(1, 'Lopa Mishra', 'admin@gmail.com', '123456');
...
(5, 'NEW', '2025-03-11', 10, 100, 200, 400);
...
--
-- Table structure for table `assignwork_technical_tb`
--

CREATE TABLE `assignwork_technical_tb` (
  `id` int(11) NOT NULL,
  `request_id` int(11) NOT NULL,
  `request_info` varchar(255) NOT NULL,
  `request_desc` text NOT NULL,
  `requester_name` varchar(100) NOT NULL,
  `requester_add1` varchar(255) NOT NULL,
  `requester_add2` varchar(255) DEFAULT NULL,
  `requester_city` varchar(100) NOT NULL,
  `requester_state` varchar(100) NOT NULL,
  `requester_zip` varchar(20) NOT NULL,
  `requester_email` varchar(100) NOT NULL,
  `requester_mobile` varchar(20) NOT NULL,
  `assign_date` date NOT NULL,
  `technician_name` varchar(100) NOT NULL,
  `technician_email` varchar(100) NOT NULL,
  `technician_mobile` varchar(20) NOT NULL,
  `work_date` date NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `assignwork_technical_tb`
--

INSERT INTO `assignwork_technical_tb` (`id`, `request_id`, `request_info`, `request_desc`, `requester_name`, `requester_add1`, `requester_add2`, `requester_city`, `requester_state`, `requester_zip`, `requester_email`, `requester_mobile`, `assign_date`, `technician_name`, `technician_email`, `technician_mobile`, `work_date`, `created_at`) VALUES
(1, 53, 'mic bad', 'no mic', 'rashmi', 'sadsdsd', 'jkjkjk', 'bhubaneswar', 'odisha', '723424', 'lopa@gmail.com', '243232323', '2025-03-13', 'Tech1', 'tech@gmail.com', '1234', '2025-03-13', '2025-03-13 07:33:38'),
(2, 53, 'mic bad', 'no mic', 'rashmi', 'sadsdsd', 'jkjkjk', 'bhubaneswar', 'odisha', '723424', 'lopa@gmail.com', '243232323', '2025-03-13', 'Tech1', 'tech@gmail.com', '1234', '2025-03-13', '2025-03-13 07:33:44');
...
(12, 'Rashmi', 'lopa@gmail.com', '1111'),
(13, 'Rashmi', 'lopa3@gmail.com', '1111'),
(14, 'Rashmi', 'lopa@gmail.com', '1111'),
(15, 'Rashmim', 'lopa5@gmail.com', '$2y$10$.55dNtBoIhTLYFDcfChshu2aFVGufLKxWGxftTwoqIIv0IkSCYks6'),
(16, 'Rashmimnmn', 'lopa7@gmail.com', '$2y$10$8z.Q3rmlznTyAL3JoINcI.bvNILl/D3CkRTHW3ipis3Sri9hREZd2'),
(17, 'Rashmi', 'lopa9@gmail.com', '$2y$10$EMcODfbqiNotmtcH2p0TMOhH2Pxz/w6mTLGr9yWFWpOscHtMcdp4.');
...
(53, 'mic bad', 'no mic', 'rashmi', 'sadsdsd', 'jkjkjk', 'bhubaneswar', 'odisha', 723424, 'lopa@gmail.com', 243232323, '2025-03-12'),
(54, 'mic bad no', 'hjhjhjh', 'rashmi', 'sadsdsd', 'jkjkjk', 'bhubaneswar', 'odisha', 723424, 'lopa@gmail.com', 243232323, '2025-03-12'),
(55, 'mic bad no', 'hjhjhjh', 'rashmi', 'sadsdsd', 'jkjkjk', 'bhubaneswar', 'odisha', 723424, 'lopa@gmail.com', 243232323, '2025-03-12');
...
(13, 'rashmi', 'bhubaneswar', 243232323, 'lopa@gmail.com');
...
--
-- Indexes for table `assignwork_technical_tb`
--
ALTER TABLE `assignwork_technical_tb`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `assignwork_technical_tb`
--
ALTER TABLE `assignwork_technical_tb`
